...
class Czname
{
    ...
    const SOURCE_ALPHABET = ['á','é','ě','í','ý','ž','ú','ů','ř','š','ď','č','ť','Á','É','Ě','Í','Ý','Ž','Ú','Ů','Ř','Š','Ď','Č','Ť','Ä','ä','Ö','ö','Ü','ü','ň','ŕ','ź','ó','ñ','Ň','Ñ','Ŕ','Ź','Ó','ķ'];
    const RESULT_ALPHABET = ['a','e','e','i','y','z','u','u','r','s','d','c','t','A','E','E','I','Y','Z','U','U','R','S','D','C','T','A','a','O','o','U','u','n','r','z','o','n','N','N','R','Z','O','k'];
